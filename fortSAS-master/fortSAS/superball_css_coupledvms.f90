module superball_css_coupledvms
  use math
  implicit none
  contains
    ...
    subroutine magnetic_oriented_formfactor(&
      ...
      double precision, intent(in) :: SLDsuperball, SLDshell, SLDsurfactant, SLDmatrix
      double precision, intent(in) :: alpha, beta
      double precision, intent(in) :: mag_DShell
      ...
      double precision function call_magnetic(q, p, Np)
        ...
        p_mag = (/p(1), mag_DShell, p(3), p(4), mag_SLDsuperball, mag_SLDshell,&
                  mag_SLDsurfactant, mag_SLDmatrix, alpha, beta/)
  ...
  endmodule superball_css_coupledvms