...
contains
  ...
  subroutine formfactor(&
    q, particleSize, d, SLDcube, SLDshell, SLDmatrix, sigParticleSize,&
      ...
      do ia=1, N_gh_order
        ...
        do ith=1, N_gl_order
          ...
          do iphi=1, N_gl_order
            ...
            call oriented_formfactor(q, current_ParticleSize, d,&
  ...
  subroutine magnetic_formfactor(&
    q, particleSize, d, SLDcube, SLDshell, SLDmatrix, sigParticleSize, mag_SLDcube, mag_SLDshell, mag_SLDmatrix,&
