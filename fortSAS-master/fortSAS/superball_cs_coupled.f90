module superball_cs_coupled
  ...
  contains
    ...
    subroutine formfactor(&
      ...
      double precision, intent(in) :: particleSize, d, p_val
      double precision, intent(in) :: SLDsuperball, SLDshell, SLDmatrix
      double precision, intent(in) :: sigParticleSize
        ...
        do iR=1, N_gh_order
          ...
          do ith=1, N_gl_order
            ...
            do iphi=1, N_gl_order
              ...
              call oriented_formfactor(q, current_ParticleSize, d, p_val,&
  ...
  endmodule superball_cs_coupled